    ...
    public class RadiologyServiceSkeleton implements RadiologyServiceSkeletonInterface{
         ...
         */
                  ...
                  )
            {
                ...
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#requestAppointment");
        }
         ...
         */
            ...
            {
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#orderRadiologyExamination");
        }
