...
public class RadiologyCallbackServiceStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"RadiologyCallbackService" + getUniqueSuffix());
	...
	public RadiologyCallbackServiceStub(
	...
	public RadiologyCallbackServiceStub() throws org.apache.axis2.AxisFault {
		...
		this("http://www.PAHospital.org/RadiologyCallbackService");
	 ...
	 */
	public RadiologyCallbackServiceStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
...

	{
		...
		_operationClient
				.getOptions()
				.setAction(
						"http://www.PAHospital.org/RadiologyCallbackService/SendRadiologyReport");
		...
		env = toEnvelope(getFactory(_operationClient.getOptions()
				.getSoapVersionURI()), radiologyReport0,
				optimizeContent(new javax.xml.namespace.QName(
						"http://www.PAHospital.org/RadiologyCallbackService/",
						"sendRadiologyReport")), new javax.xml.namespace.QName(
						"http://www.PAHospital.org/RadiologyCallbackService/",
						"sendRadiologyReport"));
	...
	public static class RadiologyReport implements
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":RadiologyReport",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "RadiologyReport", xmlWriter);
				}
		...
		private static java.lang.String generatePrefix(
			...
			if (namespace
					.equals("http://www.PAHospital.org/RadiologyCallbackService/")) {
				return "ns1";
			}
		...
		public static class Factory {
			...
			public static RadiologyReport parse(
				...
				try {
							...
							if (!"RadiologyReport".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (RadiologyReport) ExtensionMapper
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName("",
									"DateOfExamination").equals(reader
									.getName())) {
	...
	private org.apache.axiom.om.OMElement toOM(
			org.pahospital.www.radiologycallbackservice.RadiologyCallbackServiceStub.RadiologyReport param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							org.pahospital.www.radiologycallbackservice.RadiologyCallbackServiceStub.RadiologyReport.MY_QNAME,
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (org.pahospital.www.radiologycallbackservice.RadiologyCallbackServiceStub.RadiologyReport.class
					.equals(type)) {

				return org.pahospital.www.radiologycallbackservice.RadiologyCallbackServiceStub.RadiologyReport.Factory
